...
fileout <- "C:/Users/brooke.wright/Documents/BWRIGHT_NOAA/Illex/IllexData/FI_surveys/NEFSC_bts_Illex_2021-04-16.csv"
```
...
# FALL_BOT_TRAWL <- SVDBS_CRUISES %>% filter(PURPOSE=='NMFS NEFSC BOTTOM TRAWL SURVEY') #get the list of cruise numbers that correspond to  BTS
# FALL_BOT_TRAWL <- SVDBS_CRUISES %>% filter(PURPOSE == 'MASSACHUSETTS DMF BOTTOM TRAWL SURVEY'
#                                           , SEASON %in% c('FALL', 'SPRING')) #get the list of cruise numbers that correspond to  BTS
FALL_BOT_TRAWL <- SVDBS_CRUISES %>% filter(PURPOSE %in% c('NMFS NEFSC BOTTOM TRAWL SURVEY', 'MASSACHUSETTS DMF BOTTOM TRAWL SURVEY')
                                           , SEASON %in% c('FALL', 'SPRING')) #get the list of cruise numbers that correspond to  BTS
